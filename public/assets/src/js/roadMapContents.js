...
smallCircle1_1.style.backgroundColor = 'yellow'
...
firstStepButton1.addEventListener("click", () => {
    ...
    circle2.style.backgroundColor = 'yellow'
    circle3.style.backgroundColor = '#393939';
    circle4.style.backgroundColor = '#393939';
    circle5.style.backgroundColor = '#393939';
    circle6.style.backgroundColor = '#393939';
    circle7.style.backgroundColor = '#393939';
    circle8.style.backgroundColor = '#393939';
    circle9.style.backgroundColor = '#393939';
    circle10.style.backgroundColor = '#393939';
    // if(truthy1 > 0){
...
firstStepButton2.addEventListener("click", () => {
    ...
    secondContent4.style.display = 'none';
    circle1.style.backgroundColor = 'yellow'
    circle2.style.backgroundColor = '#393939'
...
secondStepButton1.addEventListener("click", () => {
    ...
    secondContent3.style.display = 'none';
    secondContent4.style.display = 'none';
    circle1.style.backgroundColor = '#393939'
    circle2.style.backgroundColor = '#393939'
    circle3.style.backgroundColor = '#393939';
    circle4.style.backgroundColor = '#393939';
    circle5.style.backgroundColor = '#393939';
...
smallButton1_1.addEventListener("click", () => {
    ...
    secondContent4.style.display = 'none';
    smallCircle1_1.style.backgroundColor = 'yellow';
    smallCircle1_2.style.backgroundColor = '#393939';
    smallCircle1_3.style.backgroundColor = '#393939';
    smallCircle1_4.style.backgroundColor = '#393939';
    smallCircle2_1.style.backgroundColor = '#393939';
    smallCircle2_2.style.backgroundColor = '#393939';
    smallCircle2_3.style.backgroundColor = '#393939';
    smallCircle2_4.style.backgroundColor = '#393939';
    // if(smalCircleTruthy1 > 0){
    //     smallCircle1_1.style.backgroundColor = ""
    //     smalCircleTruthy1-=1
    // }else{
    //     smallCircle1_1.style.backgroundColor = "yellow"
    //     smalCircleTruthy1+=1
...
smallButton1_2.addEventListener("click", () => {
    ...
    secondContent3.style.display = 'none';
    secondContent4.style.display = 'none';
    smallCircle1_1.style.backgroundColor = '#393939';
    smallCircle1_2.style.backgroundColor = 'yellow';
    smallCircle1_3.style.backgroundColor = '#393939';
    smallCircle1_4.style.backgroundColor = '#393939';
    smallCircle2_1.style.backgroundColor = '#393939';
    smallCircle2_2.style.backgroundColor = '#393939';
    smallCircle2_3.style.backgroundColor = '#393939';
    smallCircle2_4.style.backgroundColor = '#393939';
    //     if(smalCircleTruthy2 > 0){
    //     smallCircle1_2.style.backgroundColor = ""
    //     smalCircleTruthy2-=1
    // }else{
    //     smallCircle1_2.style.backgroundColor = "yellow"
    //     smalCircleTruthy2+=1
...
smallButton1_3.addEventListener("click", () => {
    ...
    smallCircle1_1.style.backgroundColor = '#393939';
    smallCircle1_2.style.backgroundColor = '#393939';
    smallCircle1_3.style.backgroundColor = 'yellow';
    smallCircle1_4.style.backgroundColor = '#393939';
    smallCircle2_1.style.backgroundColor = '#393939';
    smallCircle2_2.style.backgroundColor = '#393939';
    smallCircle2_3.style.backgroundColor = '#393939';
    smallCircle2_4.style.backgroundColor = '#393939';
    //     if(smalCircleTruthy3 > 0){
    //     smallCircle1_3.style.backgroundColor = ""
    //     smalCircleTruthy3-=1
    // }else{
    //     smallCircle1_3.style.backgroundColor = "yellow"
    //     smalCircleTruthy3+=1
...
smallButton1_4.addEventListener("click", () => {
    ...
    smallCircle1_2.style.backgroundColor = '#393939';
    smallCircle1_3.style.backgroundColor = '#393939';
    smallCircle1_4.style.backgroundColor = 'yellow';
    smallCircle2_1.style.backgroundColor = '#393939';
    smallCircle2_2.style.backgroundColor = '#393939';
    smallCircle2_3.style.backgroundColor = '#393939';
    smallCircle2_4.style.backgroundColor = '#393939';
    //     if(smalCircleTruthy4 > 0){
    //     smallCircle1_4.style.backgroundColor = ""
    //     smalCircleTruthy4-=1
    // }else{
    //     smallCircle1_4.style.backgroundColor = "yellow"
    //     smalCircleTruthy4+=1
...
smallButton2_1.addEventListener("click", () => {
    ...
    smallCircle1_3.style.backgroundColor = '#393939';
    smallCircle1_4.style.backgroundColor = '#393939';
    smallCircle2_1.style.backgroundColor = 'yellow';
    smallCircle2_2.style.backgroundColor = '#393939';
    smallCircle2_3.style.backgroundColor = '#393939';
    smallCircle2_4.style.backgroundColor = '#393939';
    //     if(smalCircleTruthy5 > 0){
    //     smallCircle2_1.style.backgroundColor = ""
    //     smalCircleTruthy5-=1
    // }else{
    //     smallCircle2_1.style.backgroundColor = "yellow"
    //     smalCircleTruthy5+=1
...
smallButton2_2.addEventListener("click", () => {
    ...
    smallCircle1_4.style.backgroundColor = '#393939';
    smallCircle2_1.style.backgroundColor = '#393939';
    smallCircle2_2.style.backgroundColor = 'yellow';
    smallCircle2_3.style.backgroundColor = '#393939';
    smallCircle2_4.style.backgroundColor = '#393939';
    //     if(smalCircleTruthy6 > 0){
    //     smallCircle2_2.style.backgroundColor = ""
    //     smalCircleTruthy6-=1
    // }else{
    //     smallCircle2_2.style.backgroundColor = "yellow"
    //     smalCircleTruthy6+=1
...
smallButton2_3.addEventListener("click", () => {
    ...
    smallCircle2_1.style.backgroundColor = '#393939';
    smallCircle2_2.style.backgroundColor = '#393939';
    smallCircle2_3.style.backgroundColor = 'yellow';
    smallCircle2_4.style.backgroundColor = '#393939';
    //     if(smalCircleTruthy7 > 0){
    //     smallCircle2_3.style.backgroundColor = ""
    //     smalCircleTruthy7-=1
    // }else{
    //     smallCircle2_3.style.backgroundColor = "yellow"
    //     smalCircleTruthy7+=1
...
smallButton2_4.addEventListener("click", () => {
    ...
    smallCircle2_2.style.backgroundColor = '#393939';
    smallCircle2_3.style.backgroundColor = '#393939';
    smallCircle2_4.style.backgroundColor = 'yellow';
    //     if(smalCircleTruthy8 > 0){
    //     smallCircle2_4.style.backgroundColor = ""
    //     smalCircleTruthy8-=1
    // }else{
    //     smallCircle2_4.style.backgroundColor = "yellow"
    //     smalCircleTruthy8+=1
...
// Get the container element small
let smallbtnContainer = document.getElementById("small_block_2020_1");

// Get all buttons with class="btn" inside the container small
let smallbtns = smallbtnContainer.getElementsByClassName("small_but");
// console.log(smallbtns);
for (let i = 0; i < smallbtns.length; i++) {
    smallbtns[i].addEventListener("click", function () {
        let current = document.getElementsByClassName("myactive");
